...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA4     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = DRV_IPROPI_Pin|T_FET_Pin|V_BUS_Pin|T_MOT_Pin
                          |POT_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA4     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, DRV_IPROPI_Pin|T_FET_Pin|V_BUS_Pin|T_MOT_Pin
                          |POT_Pin);
...
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef* hlptim)
{
  if(hlptim->Instance==LPTIM1)
  {
    ...
    PB2     ------> LPTIM1_OUT
    */
    HAL_GPIO_DeInit(LEDR_GPIO_Port, LEDR_Pin);
